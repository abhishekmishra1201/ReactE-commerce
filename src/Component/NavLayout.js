            ...
            <nav className="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
              ...
              <div className="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                ...
                <div className="navbar-nav ml-auto py-0">
                  ...
                  <i class="fas fa-shopping-cart text-primary"></i></Link>
                </div>
              </div>
            </nav>
            {/* Carousel */}
            <div id="header-carousel" className="carousel slide" data-ride="carousel">
              <div className="carousel-inner">
                <div className="carousel-item active" style={{ height: "410px" }}>
                  <img className="img-fluid" src= {process.env.PUBLIC_URL +'./img/carousel-1.jpg'} alt="Fashionable Dress" />
                ...
                <div className="carousel-item" style={{ height: "410px" }}>
                  <img className="img-fluid" src={process.env.PUBLIC_URL +'./img/carousel-2.jpg'} alt="Reasonable Price" />
                  <div className="carousel-caption d-flex flex-column align-items-center justify-content-center">
                    <div className="p-3" style={{ maxWidth: "700px" }}>
                      <h4 className="text-light text-uppercase font-weight-medium mb-3">10% Off Your First Order</h4>
